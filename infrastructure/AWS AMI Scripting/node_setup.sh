...
sudo cp /home/ubuntu/Cosmos-Validator-Utility/backend_code/systemd_services/getActiveVoteCountToS3.service /etc/systemd/system/getFinalProposalResultsToS3.service
